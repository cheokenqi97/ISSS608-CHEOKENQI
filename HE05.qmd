...
# Lesson 5a: Creating Ternary Plot with R
...
```{r}
pop_data <- read.csv("chap05/data/respopagsex2000to2018_tidy.csv")
```
...
# Lesson 5b: Visual Correlation Analysis
...
# Lesson 5c: Heatmap for Visualising and Analysing Multivariate Data
...
Preparing the data Transforming the data frame into a matrix
...
# Lesson 5d: Visual Multivariate Analysis with Parallel Coordinates Plot
...
# Lesson 5e: Treemap Visualisation with R
